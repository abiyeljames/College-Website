...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <tr>
        ...
        <td style="color: #FFFFFF; font-weight: bold; background-color: #003366" class="auto-style3">
            </td>
    </tr>
    <tr>
        <td class="style2" 
    ...
    <tr>
        ...
        <td class="style5" 
            ...
            <a href="mailto:abiyeljames3@gmail.com"><span class="style6">
            trobert@yahoo.co.in</span></a></td>
    </tr>
    <tr>
        <td class="style2" 
            style="color: #FFFFFF; font-weight: bold; background-color: #003366">
